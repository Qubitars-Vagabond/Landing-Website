    ...
    <div>
      <div className="container future_scope my-1">
        <div className="row  py-3">
          ...
          <div className="col-xs-12 col-sm-6 col-md-12 col-lg-6 col-xl-6  introduce-column px-5 pt-5">
            <h1 
            ...
            <div className="Application-group">
              ...
              <button className='Feature_play Application-group-responsive'>
                <span
                 className="m-2"
                ><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-google-play" viewBox="0 0 16 16">
