                ...
                <div className='container pt-5'>
                    <div className='row'>
                        <div className='col-lg-4'>
                            <p className='home_style'>Mapping Journeys, <br /> One Location <br /> at a Time.</p>
                            <p className='home_stylish'>Empowering Your Wanderlust by Helping You Curate, Map, and Conquer Your Bucket List Destinations.</p>
                        </div>
